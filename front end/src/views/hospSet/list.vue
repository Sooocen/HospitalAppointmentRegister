...
import hospSet from '@/api/hospSet'
    ...
    export default{
        ...
        methods:{
            ...
            getList(page = 1){
                this.current = page
                hospSet.getHospitalset(this.current,this.limit,this.searchObj)
                .then(res=>{
        ...
        //批量删除医院设置{batchDeleteHospitalSet}
        removeRows(){
            this.$confirm('此操作将永久删除医院是设置信息, 是否继续?', '提示', {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            ...
            .then(()=>{
                ...
                hospSet.batchDeleteHospitalSet(idList)
                .then( response=>{
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
